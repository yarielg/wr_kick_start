...
?>
    <div id="payment" class="woocommerce-checkout-payment col2-set step <?= $flag_require_dealer ? 'step-4' : 'step-2' ?>" style="display: none">
        ...
        <div class="form-row place-order">
            ...
            <?php echo apply_filters( 'woocommerce_order_button_html', '<button type="submit" class="button alt" name="woocommerce_checkout_place_order" id="place_order" value="Complete Order" data-value="Complete Order">Complete Order</button>' ); // @codingStandardsIgnoreLine ?>
