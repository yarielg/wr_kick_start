...
class Enqueue{
    ...
    function kmg_enqueue_map_scripts(){
        ...
        <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBMwYpxeHMJ249d2oWOfcFwyxe5kcAAcB0&callback=initMap&v=weekly" async defer></script>
        <?php
    }
    ...
    function kgm_enqueue_frontend(){
        ...
        wp_enqueue_script('checkout-js', KGM_PLUGIN_URL  . '/assets/js/checkout.js' ,array('jquery'),'1.0', true);
